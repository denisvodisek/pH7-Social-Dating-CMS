...
class JoinForm
{
    public static function step1()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Button(t('<i class="fa fa fa-heart-o"></i> Join for free!'), 'submit',  ['class' => 'btn btn-danger btn-raised btn-lg']));
    ...
    public static function step2()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Button(t('Next'), 'submit',  ['class' => 'btn btn-danger btn-raised btn-lg']));
    ...
    public static function step4()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Button(t('<i class="fa fa-image"></i> Add My Photo'), 'submit',  ['class' => 'btn btn-danger btn-raised btn-lg']));
